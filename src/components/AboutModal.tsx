    ...
    <div className="modal-overlay" role="dialog" aria-modal="true" aria-label="About" onClick={onClose}>
      <div className="modal-content about-modal" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          ...
          <button className="modal-close-btn" onClick={onClose} aria-label="Close about">✕</button>
        </div>
        ...
        <div className="modal-body">
          <section className="about-section">
            ...
            <ul className="about-list">
              ...
              <li>Eligible programs are fragmented across dozens of agencies</li>
            </ul>
          </section>
          ...
          <section className="about-section">
            ...
            <p className="about-note">By federal law, LIHTC rents are capped at 30% of the income limit for your unit type — ensuring housing stays affordable.</p>
          </section>
          ...
          <section className="about-section">
            ...
            <ol className="about-list">
              ...
              <li>Gather documents: photo ID, Social Security cards for all members, proof of income, bank statements, rental history</li>
          ...
          <section className="about-section">
            <h3>Data Sources</h3>
            <ul className="about-list">
              <li><a className="about-link" href="https://data.sanjoseca.gov" target="_blank" rel="noopener noreferrer">City of San Jose GeoHub</a> — local inventory</li>
              <li><a className="about-link" href="https://www.huduser.gov/portal/datasets/lihtc.html" target="_blank" rel="noopener noreferrer">HUD National LIHTC Database (2024)</a> — 50,000+ properties</li>
              <li><a className="about-link" href="https://www.huduser.gov/portal/datasets/il.html" target="_blank" rel="noopener noreferrer">HUD FY2024 Income Limits</a> — AMI and rent calculations</li>
              <li><a className="about-link" href="https://nominatim.openstreetmap.org" target="_blank" rel="noopener noreferrer">OpenStreetMap / Nominatim</a> — geocoding</li>
            </ul>
          </section>
